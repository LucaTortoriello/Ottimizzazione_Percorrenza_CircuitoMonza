...
% Upper bound per le V_peak interne: 360 km/h globale, beta per Parabolica
...
switch scelta
    case 1
        ...
        for k = 1:length(anni)
            ...
            % QUESTA FUNZIONE SERVE PER RUNNARE IL CODICE TENENDO
            % CONTO DI TUTTI I VINCOLI DEL PROBLEMA (AL SUO INTERNO
        ...
        fprintf('\nVELOCITÀ DI INGRESSO IN CURVA STIMATE [km/h] PER ANNO\n');
        fprintf('%-6s ', 'Anno');
